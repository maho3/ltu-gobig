...
root_in = '/home/mattho/data/quijote/Snapshots/latin_hypercube'
root_out = '/home/mattho/data/quijote/density_field/latin_hypercube'
ptypes = [1]
grid = 128
...
for sim_LH_num in sim_LH_nums:
    ...
    out_file = f'{root_out}/{sim_LH_num}/df_m_{grid}_z={0.5}.npy'
